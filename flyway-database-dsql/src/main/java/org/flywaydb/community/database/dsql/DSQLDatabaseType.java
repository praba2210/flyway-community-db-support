...
public class DSQLDatabaseType extends PostgreSQLDatabaseType implements CommunityDatabaseType {
    ...
    private static final int DEFAULT_MAX_RETRY_DELAY_SECONDS = 30;
    ...
    public ExecutionTemplate createTransactionalExecutionTemplate(Connection connection, boolean rollbackOnException) {
        ...
        // Override the connector's documented defaults (3 retries / 5s) with the configured knobs;
        ...
        OCCRetryConfig retryConfig = OCCRetryConfig.builder()
                ...
                .build();
        return new DSQLExecutionTemplate(delegate, retryConfig);
    }
